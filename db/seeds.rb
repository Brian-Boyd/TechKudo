...
###########################################
################################################################################
Kudo.create!( comment: "Mercifully otter read groundhog a until far cuffed much appalling jeepers a human excruciatingly and across more under less zebra.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "During by near in before well smart spread so goldfish engaging iguanodon ferret oh up and jeez winced by some instead or led more.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Greedy crud chameleon contumaciously tremendous mightily irrespective so grabbed neatly licentious cackled jeez between equally oversaw.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Then cost darn and unwound as and ignorantly more this beside ineffective newt or jeez jeez huskily after helpfully that irksomely.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Due that forgot much flagrantly sniffled macaw anteater newt iguana covetously where one hound energetic seal during insufferably.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Because man-of-war together trim until instead prissy and jaguar brought fled much bird and satisfactory untruthful whooped llama however.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "More far python or ouch seriously the much a according manatee more goodness this one in daintily eel compositely jeepers as well.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Familiar crud much much the but equal fatefully regardless and the alongside seagull rabbit more bestially more far across.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Aerially much darn cried spoon-fed before gecko constitutionally a gregarious incredibly goodness and this and healthily .", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Metaphorically much the gosh gosh next woodpecker far seagull as that unintelligibly and more across and far forward like before.", company_id: "7", user_id: "2" )
Kudo.create!( comment: "Some groundhog other spluttered much useful and therefore more since jeepers nudged manfully feeling and some as some blunt macaw.", company_id: "7", user_id: "2" )
